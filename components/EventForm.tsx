...
const formSchema = z.object({
    ...
    price:z.number().min(0,"pric must be 0 or greater"),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
                            ...
                            (
                                <div className='relative w-32 aspect-square bg-gray-100 rounded-lg'>
                                    ...
                                    <button
                                     ...
                                     className='absolute -top-3 -right-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center hover:bg-red-600 transition-colors'
                                     >
                                        x
                                    </button>
                                </div>
            ...
            <Button type='submit'
                ...
                className='w-full bg-gradient-to-r
                 from-blue-600 to-blue-800 hover:from-blue-700
                 hover:to-blue-900 text-white font-medium py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2'>
                    {
                        isPending ? (
                            <>
